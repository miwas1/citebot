...
See [the private-server deployment runbook](docs/private-server-deployment.md)
for the supported network layout, reverse-proxy examples, secret handling,
backup guidance, and operational boundaries.
